...
<html lang="en">
  ...
  <body>
    ...
    <script type = "module">
      // IMPORT HERE
      import sayHello, {greeting} from "./06-module-helpers.js";
      import validateLoginData from "./06-modules-authentication.js";
      ...
      elFormGreeting.onsubmit = function (a) {
          a.preventDefault();
          greeting(elInputName.value);
      }
      elFormLogin.onsubmit = function (b) {
          b.preventDefault();
          const email = elInputEmail.value
          const password = elInputPassword.value

          const alertMessage = validateLoginData(email, password)
          alert(alertMessage)
      }
    </script>
  </body>
