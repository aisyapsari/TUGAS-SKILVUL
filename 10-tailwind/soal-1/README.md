  ...
  <body>
    ...
    <div class="min-h-screen max-w-7xl mx-auto bg-gray-100 grid grid-cols-12">
      <ol class="col-span-4 bg-white block">
        <li
          class="font-medium uppercase px-3 py-2 border-l-8 border-red-500 text-red-500  cursor-pointer hover:text-red-500 tracking-widht font-bold"
        >
          home
        </li>
        <li
      ...
      <div id="content" class="col-span-8 bg-red-100 p-8 md:px-16 md:py-8">
        <div id="summary-card" class="grid grid-cols-4 gap-3">
          <div class="bg-white h-28 w-full p-5 rounded filter drop-shadow-md">
            <h1 class="text-4xl font-semibold">2000</h1>
            <p class="text-lg font-light capitalize">product</p>
          </div>
          <div class="bg-white h-28 w-full p-5 rounded filter drop-shadow-md">
            <h1 class="text-4xl font-semibold">47</h1>
            <p class="text-lg font-light capitalize">tag</p>
          </div>
          <div class="bg-white h-28 w-full p-5 rounded filter drop-shadow-md">
            <h1 class="text-4xl font-semibold">260</h1>
            <p class="text-lg font-light capitalize">supplier</p>
          </div>
          <div class="bg-white h-28 w-full p-5 rounded filter drop-shadow-md">
            <h1 class="text-4xl font-semibold">150</h1>
